...
void toko::sorting(){
  cout<<"==============================================="<<endl;
  cout<<"=============APLIKASI DATA STOK BARANG============="<<endl;
  cout<<"==============================================="<<endl;
  cout<<" Inputkan banyak data barang : "cin>>n;
  for(int i=1; i<=n; i++){
  cout<<" Masukkan nama barang : ";cin>>namabrg;
  cout<<" Masukkan id barang : ";cin>>id;
  cout<<" Masukkan stok barang : ";cin>>Arr[i];
    }
  for(int i=1; i<=n; i++)
    {
      for(int j=1; j<=n; j++){
  ...
  for(i=1; i<=n; i++){
    cout<<" stok barang (setelah diurutkan) : "<<Arr[i]<<endl;
  }
